...
/*
|--------------------------------------------------------------------------
| Subdirectory front-controller path fix (XAMPP /rent247)
|--------------------------------------------------------------------------
|
| When Apache rewrites /rent247/* into /rent247/public/*, SCRIPT_NAME still
| contains "/public/index.php", so Laravel treats the base path as
| /rent247/public and every route 404s. Strip "/public" from the script
| path so the app lives at /rent247.
|
*/
