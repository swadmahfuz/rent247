...
export default function Index({ auth, months, byTenant, profitRows, outstandingByTenant = [], summary }) {
    ...
    return (
        <AuthenticatedLayout user={auth.user} header={<h2 className="font-semibold text-xl text-slate-800">Analytics</h2>}>
            <Head title="Analytics" />
            <div className="py-8 max-w-7xl mx-auto sm:px-6 lg:px-8 space-y-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                    {[
                        ['Billed YTD', money(summary?.billed_ytd)],
                        ['Collected YTD', money(summary?.collected_ytd)],
                ...
                <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                    ...
                    <table className="min-w-full text-sm">
                        <thead className="bg-slate-50 text-left">
                            <tr><th className="px-4 py-3">Month</th><th className="px-4 py-3">Billed</th><th className="px-4 py-3">Collected</th><th className="px-4 py-3">Utility cost</th><th className="px-4 py-3">Profit</th></tr>
                        </thead>
                        <tbody>
                            {profitRows.map((r) => (
                ...
                <div className="grid lg:grid-cols-2 gap-6">
                    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <table className="min-w-full text-sm">
                            <thead className="bg-slate-50 text-left"><tr><th className="px-4 py-3">Tenant</th><th className="px-4 py-3">Billed</th><th className="px-4 py-3">Collected</th></tr></thead>
                            <tbody>
                                {byTenant.map((r) => (
                    ...
                    <div className="bg-white rounded-lg shadow-sm overflow-hidden">
                        ...
                        <table className="min-w-full text-sm">
                            <thead className="bg-slate-50 text-left">
                                <tr><th className="px-4 py-3">Tenant</th><th className="px-4 py-3">Invoices</th><th className="px-4 py-3">Age (days)</th><th className="px-4 py-3">Balance</th></tr>
                            </thead>
                            <tbody>
